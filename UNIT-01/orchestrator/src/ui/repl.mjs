/**
 * REPL — interactive read-eval-print loop for UNIT-01.
 *
...
export async function startRepl(loop, settings) {
    ...
    console.log('\x1b[1mUNIT-01 — Orchestrator\x1b[0m — type your prompt or /help');
    ...
    const askPrompt = () => {
        rl.question('\x1b[36m>\x1b[0m ', async (input) => {
            ...
            if (trimmed.startsWith('/')) {
                ...
                const { response, exit } = await executeCommand(trimmed, loop.state);
